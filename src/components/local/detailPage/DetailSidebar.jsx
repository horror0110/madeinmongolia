  ...
  return (
    <div className="">
      ...
      <div className="flex flex-col my-3 border rounded-md shadow mt-4 w-[250px]">
        <h1 className="border-b w-full p-2">Нийлүүлэгчийн ангиллууд</h1>

        <span className="text-[13px] p-4">Тоглоом</span>
      </div>
      ...
      <div className="border w-[250px]">
        <h1 className="border-b p-3">Нийлүүлэгчийн эрэлттэй бараа</h1>
